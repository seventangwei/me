...
export function Section({ title, icon, href, children, className }: SectionProps) {
  return (
    <section className={clsx('group/section max-lg:mx-4')}>
      <div className={clsx('mb-4 mt-8 inline-flex w-full items-center justify-between md:mt-6', className)}>
